          ...
          <h3 class="box-title">List Siswa</h3>
            <div class="table-responsive">
              <table class="table text-nowrap">
                ...
                <tbody>
                  <?php  $data = $mysqli->query("SELECT * FROM tb_kelas as tbk JOIN tb_matkul as tbm ON tbm.id_matkul=tbk.id_matkul WHERE tbk.id_guru='$_SESSION[id_guru]'"); ?>
                  <?php $no = 0; ?>
                  <?php while($value = $data->fetch_object()){ ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="v_nilai.php?id_kelas=<?= $value->id_kelas; ?>" class="btn btn-info text-white">Lihat Siswa</a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>

    ...
    <div class="container-fluid">
      ...
      <div class="row">
            ...
            <div class="user-bg">
              <div class="overlay-box">
                <div class="user-content">
                  ...
                  <?php endif; ?>
                  <h5 class="text-white"><?= date('d F Y', strtotime($myprofil->tanggal_lahir)); ?></h5>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-8 col-xlg-9 col-md-12">
          <div class="card">
            <div class="card-body">
              <form class="form-horizontal form-material" action="../controller/profil/siswa.php" method="post">
                ...
                <div class="form-group mb-4">
                  ...
                  <div class="col-md-12 border-bottom p-0">
                    <input type="date"  class="form-control p-0 border-0" name="tgl_lahir" value="<?= $myprofil->tanggal_lahir; ?>">
                  </div>
                </div>
                <div class="form-group mb-4">

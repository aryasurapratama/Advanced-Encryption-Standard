      ...
      <div class="row">
        ...
        <div class="white-box">
          ...
          <div class="row col-lg-12">
            <form action="../controller/kelas/add_kelas.php" method="post">
              <div class="form-row">
                ...
                <div class="form-group col-md-12">
                  ...
                  <input type="time" class="form-control" name="wkt_mulai" placeholder="Waktu Mulai" required>
                </div>
                <div class="form-group col-md-12">
                  <label for="inputEmail4">Waktu Akhir</label>
                  <input type="time" class="form-control" name="wkt_akhir" placeholder="Waktu Akhir" required>
                </div>
              </div>

            ...
            <form action="../controller/guru/add_guru.php" method="post">
              <div class="form-row">
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" id="inputEmail4" name="fname" placeholder="Nama depan" required>
                </div>
                <div class="form-group col-md-12">
                  <label for="inputEmail4">Nama Belakang</label>
                  <input type="text" class="form-control" id="inputEmail4" name="lname" placeholder="Nama belakang" required>
                </div>
